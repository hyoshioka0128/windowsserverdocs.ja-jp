...
ms.locfileid: "9150852"
---
# Windows Server 2016 のライセンス認証
...
>[!NOTE]
>**注:** 更新プログラムは、これらの新しいクライアントのいずれかのライセンス認証をサポートするために KMS サーバー上に必要な可能性があります。 ライセンス認証のエラーが発生したときは、この表の下に示した適切な更新プログラムを適用してあるかどうかを確認してください。
