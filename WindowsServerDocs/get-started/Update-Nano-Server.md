...
## <a name="option-5-download-and-install-the-cumulative-update-to-a-running-nano-server"></a>オプション 5:累積的な更新プログラムをダウンロードして実行中の Nano Server にインストールする
