...
|-------------|----------------------|----------|--------|----------|------------|---------|-----------------|--------|---------------|  
|DC_1|Windows Server 2012|スキーママスタ、ドメイン名前付けマスタ|〇|X|〇|X|X|〇|〇|  
|DC_2|Windows Server 2012|なし|〇|X|〇|〇|X|〇|〇|  
|DC_3|Windows Server 2012|インフラストラクチャ マスタ|X|X|X|〇|〇|〇|〇|  
|DC_4|Windows Server 2012|PDC エミュレーター、RID マスター|〇|X|X|X|X|〇|X|  
|DC_5|Windows Server 2012|なし|X|X|〇|〇|X|〇|〇|  
|RODC_1|Windows Server 2008 R2|なし|〇|〇|〇|〇|〇|〇|X|  
|RODC_2|Windows Server 2008|なし|〇|〇|X|〇|〇|〇|X|  
