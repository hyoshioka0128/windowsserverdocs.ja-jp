...
|**ソース**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**重要度**|エラー|  
|**メッセージ**|*<COMPUTERNAME>* 複製された DC のドメイン コント ローラー アカウントを作成できませんでした。<br /><br />元の DC の名前: %1<br /><br />複製された DC の最大数: %2<br /><br />複製することによって生成できるドメイン コント ローラー アカウントの数に制限 *<COMPUTERNAME>* を超えています。|  
...
|-|-|-|  
|**イベント ID**|**ソース**|**メッセージ**|  
|**103**|ESENT|DFSRs (1360) \\ \\.\C:\System ボリューム information \dfsr\database *_<GUID>* \dfsr.db:データベース エンジンはインスタンス (0) を停止しました。<br /><br />ダーティ シャットダウン:0<br /><br />内部のタイミング シーケンス: [1] 0.000、[2] 0.000、[3] 0.000、[4] 0.000、[5] 0.141、[6] 0.000、[7] 0.000、[8] 0.000、[9] 0.000、[10] 0.000、[11] 0.016、[12] 0.000、[13] 0.000、[14] 0.000、[15] 0.000。|  
|**102**|ESENT|DFSRs (532) \\\\.\C:\System Volume Information\DFSR\database *_<GUID>* \dfsr.db:データベース エンジン (6.02.8189.0000) が新しいインスタンス (0) を起動しています。|  
|**105**|ESENT|DFSRs (532) \\\\.\C:\System Volume Information\DFSR\database *_<GUID>* \dfsr.db:データベース エンジンは新しいインスタンス (0) を開始しました。 (時間 = 0 秒)<br /><br />内部のタイミング シーケンス: [1] 0.000、[2] 0.000、[3] 0.000、[4] 0.000、[5] 0.000、[6] 0.000、[7] 0.000、[8] 0.000、[9] 0.031、[10] 0.000、[11] 0.000。|  
|||DFSRs (532) \\\\.\C:\System Volume Information\DFSR\database *_<GUID>* \dfsr.db:新しいデータベースを作成して、データベース エンジン (1, \\ \\.\C:\System ボリューム information \dfsr\database *_<GUID>* \dfsr.db)。 (時間 = 0 秒)<br /><br />内部のタイミング シーケンス: [1] 0.000、[2] 0.000、[3] 0.016、[4] 0.062、[5] 0.000、[6] 0.016、[7] 0.000、[8] 0.000、[9] 0.015、[10] 0.000、[11] 0.000。|  
