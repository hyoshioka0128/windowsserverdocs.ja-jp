...
#### <a name="knownlikely-issues-and-support-scenarios"></a>既知の問題および可能性の高い問題とサポートのシナリオ  
...
|解決策と説明|無視してください。 ADDSDeployment Windows PowerShell は、前提条件チェックの際に 1 度、ドメイン コントローラーの構成中にもう 1 度、合計 2 度警告を表示します。 DNS 委任を構成したくない場合は、以下の引数を使用してください。<br /><br />コード - - creatednsdelegation: $false<br /><br />このメッセージの表示を防止する目的で前提条件チェック** を省略することは避けてください|  
...
|解決策と説明|Win2012 のフォレスト機能モードを指定するときは**、Win2012 のドメイン機能モードも指定してください。 以下のように指定するとエラーが発生せずに動作します<br /><br />コード - - forestmode Win2012 - domainmode Win2012]|  
