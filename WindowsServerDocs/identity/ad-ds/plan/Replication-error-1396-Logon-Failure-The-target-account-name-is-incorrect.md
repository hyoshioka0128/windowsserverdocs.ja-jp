...
<developerConceptualDocument xmlns="https://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="https://www.w3.org/1999/xlink" xmlns:xsi="https://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="https://ddue.schemas.microsoft.com/authoring/2003/5 http://clixdevr3.blob.core.windows.net/ddueschema/developer.xsd"> <introduction>
    <para>この記事に説明します、現象、原因と Win32 エラー 1396 で失敗する Active Directory レプリケーションの解決方法。&quot;ログオン エラー:対象のアカウント名が正しくありません。&quot; </para>
    <list class="bullet">
      <listItem>
        <para>
    ...
    <content>
      <list class="ordered">
        <listItem>
          ...
          <para>参照されている SPN (E3514235-4B06-11D1-AB04-00C04FC2DCD2/&lt;オブジェクト ソース ドメイン コント ローラーの NTDS 設定オブジェクトの guid&gt;/&lt;ターゲット ドメイン&amp;amp; gt;。&amp;amp; lt; tld&amp;amp; gt; @&lt;ターゲット ドメイン&gt;.&lt;tld&gt;</para>
