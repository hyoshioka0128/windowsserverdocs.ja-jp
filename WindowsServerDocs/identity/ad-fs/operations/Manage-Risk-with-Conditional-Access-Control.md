...
|管理されているデバイス|デバイスは管理サービスによって管理されています。|
...
|Proxy|要求が渡されるフェデレーション サーバー プロキシの DNS 名。|
...
## <a name="managing-risk-with-conditional-access-control"></a><a name="BKMK_2"></a>条件付き Access Control によるリスク管理
