...
-   [チュートリアルガイド: 条件付き Access Control によるリスク管理](Walkthrough-Guide--Manage-Risk-with-Conditional-Access-Control.md)  
...
Active Directory (AD) でユーザーアカウントとグループアカウントを作成する方法の詳細については、「 [https://technet.microsoft.com/library/cc783323%28v=ws.10%29.aspx](https://technet.microsoft.com/library/cc783323%28v=ws.10%29.aspx)」を参照してください。  
...
5.  フェデレーション サーバーで動作するように **claimapp** を構成するには、次の手順を実行します。  
    ...
    2.  アプリケーションの構成の場所を**C:inetputclaimappweb.config**に設定し、アプリケーションの URI にサイトの URL を設定します。または、 **https://webserv1.contoso.com** します。 **[次へ]** をクリックします。  
