...
このドキュメントには、すべての Windows Server 2016 の AD FS のドキュメントの操作の一覧が含まれています。 これには、次のデータが含まれます。  
...
- [AD FS 2016 シングル サイン オンの設定](../ad-fs/operations/AD-FS-2016-Single-Sign-On-Settings.md)
...
- [属性ストアを追加します。](../ad-fs/operations/Add-an-Attribute-Store.md)
- [AD FS での複合認証と AD DS クレーム](../ad-fs/operations/AD-FS-Compound-Authentication-and-AD-DS-claims.md)
- [AD FS 2016 と Azure MFA を構成する](../ad-fs/operations/Configure-AD-FS-2016-and-Azure-MFA.md)
...
- [ユーザー証明書認証用の AD FS を構成します。](../ad-fs/operations/Configure-User-Certificate-Authentication.md)
