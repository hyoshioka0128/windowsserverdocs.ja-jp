...
- タスクのタイトルと同じテキストを使用する必要はありません。UI のコンテキストで意味のあるテキストを使用しますが、2つの間に論理接続があることを確認してください。 例:
...
|障害             |"できませんでした" で終了し、ソフトウェアで実行できなかった内容を含めます。 次に例を示します。<br> *ボリューム ' Customer data ' を作成できませんでした。*|
...
|    Context                                 |    ヒントを記述する方法    |
|    -----------------------                 |    -------------------------    |
|コントロールまたは UI 要素のラベルが付けられていない場合...|単純でわかりやすい名詞句を使用します。 例:<br> ペンの強調表示 |
