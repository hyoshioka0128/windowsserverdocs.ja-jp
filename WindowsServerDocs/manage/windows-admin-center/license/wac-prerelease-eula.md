...
2. **プレリリース ソフトウェア。** 本ソフトウェアは、プレリリース版です。 正常に動作しない場合があります。 発売される最終製品版では、機能が変更されることがあります。 また、最終製品版が発売されない場合もあります。 本契約に基づいて権利を使用する場合は、それがお客様の独自の裁量によるものであることに同意するものとします。また、ソフトウェアに起因または関連して生じる可能性のあるすべての損害についてお客様が一切の責任とリスクを負うものとします。操作の非可用性または中断、またはデータまたはその他のコンテンツの損失を含みますが、これに限定されません。
...
5. **補償。** お客様は、稼働中の運用環境でのソフトウェアの使用に関する要求に基づいている範囲において、マイクロソフトに対してサード パーティが行った要求または措置を弁護することに同意するものとします。 お客様は、そのような要求や措置に帰するマイクロソフトが合理的に被った費用、損害、および料金 (弁護士費用を含む) に対してマイクロソフトを補償および免責するものとします。 
