...
|**名前** |サービスのキー (内部) 名|
|**インストール** |常にインストール:サービスは Server Core とデスクトップ エクスペリエンス搭載サーバー上にあります。 デスクトップ エクスペリエンス搭載のみ:サービスはデスクトップ エクスペリエンス搭載 Windows Server 2016 上にありますが、Server Core 上には***ありません*** |
