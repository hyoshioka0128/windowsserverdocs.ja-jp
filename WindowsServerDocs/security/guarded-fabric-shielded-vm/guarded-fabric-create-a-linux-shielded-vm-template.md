...
> Linux のシールドされた VM テンプレートディスクを準備するには、windows Server バージョン1709または Windows Server 2019 で使用可能なリモートサーバー管理ツールで利用可能な[保護-TemplateDisk](/powershell/module/shieldedvmtemplate/protect-templatedisk?view=win10-ps)コマンドレットを使用してください。
