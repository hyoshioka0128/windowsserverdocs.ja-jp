...
|{im \| install-manifest} \<Manifest>|マニフェストからイベント発行元およびログをインストールします。 イベント マニフェストと、このパラメーターを使用する方法の詳細については、Microsoft Developers Network (MSDN) の Web サイトで Windows イベント ログの SDK を参照してください ([https://msdn.microsoft.com](https://msdn.microsoft.com))。|
|{um \| uninstall-manifest} \<Manifest>|マニフェストからのすべての発行元およびログをアンインストールします。 イベント マニフェストと、このパラメーターを使用する方法の詳細については、Microsoft Developers Network (MSDN) の Web サイトで Windows イベント ログの SDK を参照してください ([https://msdn.microsoft.com](https://msdn.microsoft.com))。|
