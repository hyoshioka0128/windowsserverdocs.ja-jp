...
description: サブコマンド set TransportServer のリファレンストピック。トランスポートサーバーの構成設定を設定します。
...
transportserver コマンドを使用して[サブコマンド: 開始 transportserver](subcommand-start-transportserver.md)
