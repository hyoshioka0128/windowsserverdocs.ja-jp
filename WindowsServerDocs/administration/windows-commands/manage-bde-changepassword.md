...
ms.locfileid: "80840175"
---
# <a name="manage-bde-changepassword"></a>manage-bde: changepassword



データ ドライブでパスワードを変更します。 ユーザーは、新しいパスワードの入力を求められます。 このコマンドの使用方法の例については、次を参照してください。 [例](#BKMK_Examples)します。
...
次の例では、 **-changepassword**コマンドを使用して、データドライブ D で BitLocker のロックを解除するために使用されるパスワードを変更しています。
```
