...
|            /delete            |                                                                                                                                                       場合 *ShareName* または <em>ドライブ</em> **:** <em>パス</em> が指定されている、指定された共有を削除します。 @No__t-0 が指定されている場合、はすべての NFS 共有を削除します。                                                                                                                                                       |
...
[ネットワークファイルシステムのサービスのコマンドリファレンス](services-for-network-file-system-command-reference.md)関連項目