...
- **Hyper-v ハイパーバイザー論理プロセッサ (\*)\\合計実行時間の割合**論理プロセッサの非アイドル時間の合計

- **Hyper-v ハイパーバイザー論理プロセッサ (\*)\\% Guest 実行時間**ゲスト内またはホスト内でサイクルを実行するために費やされた時間

- **Hyper-v ハイパーバイザー論理プロセッサ (\*)\\% ハイパーバイザー実行時間**ハイパーバイザー内での実行に費やされた時間

- **Hyper-v ハイパーバイザールート仮想プロセッサ (\*)\\\\** * は、ルートパーティションの CPU 使用率を測定します

- **Hyper-v ハイパーバイザー仮想プロセッサ (\*)\\\\** * ゲストパーティションの CPU 使用率を測定します
