...
- **既存の環境 &ndash; の場合**「[記憶域の制限](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-2000-server/cc961769(v=technet.10))」の「最適化によって解放されるディスク領域のログをアクティブ化するには」セクション
- **新しい環境 &ndash; の場合**「 [Active Directory ユーザーと組織単位の増加見積もり」と](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-2000-server/cc961779(v=technet.10))いうタイトルの記事。
...
|メモ|ボトルネック分析|ディスク|バス|アダプター|PCI バス|
|-|-|-|-|-|-|
