...
| 高性能 | 高電力消費のコストでパフォーマンスが向上します。 電源と温度の制限、運用経費、および信頼性に関する考慮事項が適用されます。 | 低待機時間アプリと、プロセッサパフォーマンスの変化に影響するアプリコード | プロセッサは常に最高のパフォーマンス状態 ("ターボ" 周波数を含む) でロックされます。 すべてのコアは保留されていません。 熱の出力は重要な場合があります。 |
