...
### Windows Admin Center による UI を使用しないオンプレミス システム、リモート システム、およびシステムの管理
...
### サーバー マネージャーを使用したオンプレミス システムの管理
[サーバー マネージャー](server-manager/server-manager.md)は、Windows Server のフル インストールに含まれる管理コンソールです  (UI を持たないインストールでは使用できません。サーバー・コアには、サーバー マネージャーが含まれていません)。サーバー マネージャを使用して、サーバー ロールのインストールと削除、リモートサーバーの追加と削除、サービスの開始と停止、環境に関して収集したデータの表示を行うことができます。

### リモート システムと UI のないシステムの管理には、リモート サーバー管理ツール (RSAT) を使用します。
...
### Windows Server システムの更新プログラムの管理
...
### [セットアップおよびブート イベント収集](get-started-with-setup-and-boot-event-collection.md)
...
### [ソフトウェア インベントリ ログ (SIL)](software-inventory-logging/get-started-with-software-inventory-logging.md)
...
### [ユーザー アクセス ログ (UAL)](user-access-logging/get-started-with-user-access-logging.md)
...
### [Windows のコマンド](windows-commands/windows-commands.md)
