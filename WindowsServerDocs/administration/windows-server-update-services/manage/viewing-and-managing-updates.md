...
-   メタデータ: は、更新プログラムに関する情報を提供します。 たとえば、メタデータは、ので、更新プログラムは便利な新機能を確認できるように更新プログラムのプロパティの情報を提供します。 メタデータには、マイクロソフトソフトウェアライセンス条項も含まれます。 更新プログラムのダウンロードされたメタデータ パッケージは、実際の更新ファイル パッケージよりかなり小さくします。
...
### <a name="superseding-icon"></a>置き換えるアイコン
 ![icon](../../media/wsus/wsus-superseding.png) この更新プログラムは他の更新プログラムよりも優先します。
...
### <a name="superseded--superseding-icon"></a>置き換えられる & 置き換えるアイコン
 ![icon](../../media/wsus/wsus-superseded.png) この更新プログラムは別の更新プログラムによって置き換えられ、他の更新プログラムよりも優先されます。
...
### <a name="superseded-icon"></a>［優先］アイコン
 ![icon](../../media/wsus/wsus-superseded-leaf.png) この更新プログラムは別の更新プログラムによって置き換えられています。
