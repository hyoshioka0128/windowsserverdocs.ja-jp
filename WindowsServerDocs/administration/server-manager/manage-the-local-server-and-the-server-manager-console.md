...
> 
> **[プロパティ]** タイルに表示されるプロパティの多くは、サーバーマネージャーの一部ではないツール (コントロールパネルなど) によって制御されるため **、プロパティの設定を**変更しても、 **[プロパティ]** タイルには表示されません。直後. 既定では、 **[プロパティ]** タイルのデータは 2 分おきに更新されます。 **プロパティ**タイルデータをすぐに更新するには、サーバーマネージャーアドレスバーの [最新の情報に**更新**] をクリックします。
...
|Internet Explorer (IE) セキュリティ強化の構成|IE セキュリティ強化の構成 (IE のセキュリティ強化、IE ESC とも呼ばれます) が有効か無効かが表示されます。 **[Internet Explorer セキュリティ強化の構成]** ダイアログ ボックスを開きます。 IE セキュリティ強化の構成とは、Web ページが Internet Explorer で開かれるのを防ぐ、サーバーのためのセキュリティ対策です。 IE セキュリティ強化の構成、その利点、および設定の詳細については、「[Internet Explorer:セキュリティ強化の構成 @ no__t-0。|
