...
3.  PowerShell プロンプトで、「**[Stop-SilLogging](https://technet.microsoft.com/library/dn283394.aspx)**」と入力します。
...
-   **[Get-SilUalAccess](https://technet.microsoft.com/library/dn283389.aspx)**: クライアントからサーバーに対する 2 日前からの一意のデバイス要求とユーザー要求の合計数を表示します。
...
[Windows PowerShell](https://technet.microsoft.com/library/dn283390.aspx) 
