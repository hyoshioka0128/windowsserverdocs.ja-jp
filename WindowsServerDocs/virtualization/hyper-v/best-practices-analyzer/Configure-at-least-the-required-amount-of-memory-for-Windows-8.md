---
title: 以上の Windows 8 を実行し、動的メモリを有効には、仮想マシンのメモリ必要量を構成します。
...
ms.locfileid: "59886213"
---
# <a name="configure-at-least-the-required-amount-of-memory-for-a-virtual-machine-running-windows-8-and-enabled-for-dynamic-memory"></a>以上の Windows 8 を実行し、動的メモリを有効には、仮想マシンのメモリ必要量を構成します。
...
## <a name="issue"></a>**問題**  
*Windows 8 に必要なメモリの量よりも少ないリソースで動的メモリを使用する 1 つまたは複数の仮想マシンが構成されます。*  
