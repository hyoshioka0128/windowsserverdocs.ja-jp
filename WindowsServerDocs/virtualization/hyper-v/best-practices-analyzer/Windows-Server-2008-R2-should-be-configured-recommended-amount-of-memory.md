---
title: Windows Server 2008 R2 は、推奨されるメモリ量を構成する必要があります。
...
ms.locfileid: "59865363"
---
# <a name="windows-server-2008-r2-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows Server 2008 R2 は、推奨されるメモリ量を構成する必要があります。
...
*Windows Server 2008 R2 を実行する仮想マシンは、2 gb の RAM の推奨される量よりも少ないリソースで構成されます。*  
