---
title: Windows Server 2012 R2 を推奨されるメモリ量を構成する必要があります。
...
ms.locfileid: "59812153"
---
# <a name="windows-server-2012-r2-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows Server 2012 R2 を推奨されるメモリ量を構成する必要があります。
...
## <a name="issue"></a>**問題**  
*Windows Server 2012 R2 を実行する仮想マシンは、2 gb の RAM の推奨される量よりも少ないリソースで構成されます。*  
