...
## <a name="BKMK_HyperVManager"></a>HYPER-V マネージャーを使用して仮想マシンを作成します。  
...
4.  各ページでは、仮想マシンの適切な選択を行います。 詳細については、次を参照してください。[新しい仮想マシンのオプションと既定値は、Hyper-v マネージャーで](#BKMK_Options)このトピックで後述します。  
...
## <a name="BKMK_PowerShell"></a>Windows PowerShell を使用して仮想マシンを作成します。  
...
## <a name="BKMK_Options"></a>Hyper V マネージャー仮想マシンの新規作成ウィザードのオプション  
...
|**要約**|正しいことを検証できるように、選択したオプションが表示されます。<br /><br />-名前<br />世代<br />メモリ<br />-ネットワーク<br />ハード ディスク<br />オペレーティング システム|**クォータを調整する**ページから、概要をコピーして、電子メールや、仮想マシンを追跡するための別の場所に貼り付けます。|  

## <a name="see-also"></a>関連項目  

- [New-VM](https://technet.microsoft.com/library/hh848537.aspx)  

- [サポートされている仮想マシンの構成のバージョン](../deploy/Upgrade-virtual-machine-version-in-Hyper-V-on-Windows-or-Windows-Server.md#BKMK_SupportedConfigVersions)  
