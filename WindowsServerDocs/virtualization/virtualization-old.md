...
Windows Server 仮想化テクノロジには、セキュリティ、拡張性、信頼性を向上し、HYPER-V、HYPER-V 仮想スイッチ、保護されたファブリックとシールドされた仮想マシンの \(VMs\) に更新プログラムが含まれます。 フェールオーバー クラスタリング、ネットワーク、記憶域に対する更新により、Hyper-V で使用する場合でも、これらのテクノロジの展開と管理が容易になっています。 
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Hyper\-V 仮想スイッチは、Hyper\-V サーバー ロールをインストールすると、Hyper\-V マネージャーで使用できます。</p>
