            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Hyper\-ソフトウェアは、仮想スイッチの V\-ベースのレイヤー\-ハイパースレッディングのすべてのバージョンに含まれている 2 つのイーサネット ネットワーク スイッチ\-V します。</p>

                        <p>ハイパー\-V 仮想スイッチが使用可能なハイパースレッディングで\-、ハイパースレッディングをインストールした後、V マネージャー\-サーバーの役割をインストールします。</p>

                        <p>ハイパースレッディングに含まれる\-V 仮想スイッチは仮想マシンの仮想ネットワークと物理ネットワークの両方に接続するためのプログラムで管理し、拡張機能。</p> 
          ...
          <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Windows コンテナー</h3>
                        <p>Windows コンテナーは、オペレーティング システムを提供\-により、1 つのシステム上で実行する複数の分離アプリケーション レベルの仮想化します。 この機能では、2 種類のコンテナー ランタイムを使用します。それぞれ、アプリケーションの分離の度合いが異なります。</p>
                    </div>
                </div>
            </div>
        </div>
