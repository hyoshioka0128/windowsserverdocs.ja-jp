...
2. 接続するコンピューターの次の情報を入力します。
  ...
  - **ユーザー名** – リモート PC のアクセスに使用するユーザー名。 次の形式を使用することができます: *user_name*、 *domain \user_name*、または *user_name@domain.com*します。 ユーザー名とパスワードを要求するかどうかを指定できます。
