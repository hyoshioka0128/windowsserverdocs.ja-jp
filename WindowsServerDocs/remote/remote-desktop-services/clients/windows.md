---
title: Windows でリモート デスクトップを使ってみる
description: Windows 用のリモート デスクトップ クライアントの基本設定手順。
ms.custom: na
...
---
# <a name="get-started-with-remote-desktop-on-windows"></a>Windows でリモート デスクトップを使ってみる
