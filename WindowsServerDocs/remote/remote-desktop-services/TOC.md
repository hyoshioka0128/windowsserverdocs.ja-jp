...
#### [デスクトップ ホスティング用の Azure サービスと考慮事項](Azure-services-and-considerations-for-desktop-hosting.md)
...
#### [RD セッション ホスト ファームを使用して既存の RDS コレクションをスケール アウトする](rds-scale-rdsh-farm.md)
...
#### [個人用セッション デスクトップ環境を展開および管理する](rds-personal-session-desktops.md)
...
### [Windows 10 Version 1803 を仮想デスクトップ インフラストラクチャ (VDI) の役割用に最適化する](rds-vdi-recommendations-1803.md)
