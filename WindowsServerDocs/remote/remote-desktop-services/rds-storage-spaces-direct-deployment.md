...
これで、`\\my-sofs1\UpdStorage` に共有が作成され、ユーザーに対して [UPD を有効](https://techcommunity.microsoft.com/t5/ask-the-performance-team/migrating-user-profile-disks-in-remote-desktop-services/ba-p/375630)にしたときに UPD 記憶域に使用できます。
