...
5.  コンソールツリーでレプリケーションを強制的に実行するには、[詳細] ウィンドウで [ **Sites\Default-First-Site-name\Servers\DC1\NTDS の設定**] を展開し、を右クリックし **<automatically generated>** て [**今すぐレプリケート**] をクリックし、[**今すぐレプリケート**] ダイアログボックスで [ **OK**] をクリックします。
