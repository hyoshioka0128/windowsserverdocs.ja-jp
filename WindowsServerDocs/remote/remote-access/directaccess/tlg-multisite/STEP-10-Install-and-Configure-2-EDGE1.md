...
## <a name="installOS"></a>2-EDGE1 にオペレーティングシステムをインストールする  
...
## <a name="tcpip"></a>TCP/IP のプロパティを構成する  
...
## <a name="routing"></a>サブネット間のルーティングを構成する  
...
## <a name="certs"></a>2 EDGE1 で証明書を取得する  
...
## <a name="Access"></a>CORP\User1 へのアクセスを提供する  
...
## <a name="InstallDA"></a>2-EDGE1 にリモートアクセスの役割をインストールします。  
