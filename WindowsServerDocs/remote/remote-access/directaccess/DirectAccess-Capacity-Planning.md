...
|--|--|--|
| ダブル トンネル<p>-PKI<p>-DNS64/NAT64 を含む | 750 のコンカレント接続、50% CPU、50% メモリ、Corpnet NIC スループット 75 Mbps。 拡大のターゲットは 1,000 ユーザー @ 50% CPU です。 | 1500 のコンカレント接続、50% CPU、50 % メモリ、Corpnet NIC スループット 150 Mbps。 |
