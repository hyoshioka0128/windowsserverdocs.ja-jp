...
1. 使用するネットワーク アダプターのトポロジを決定します。 リモート アクセスは次のいずれかを使ってセットアップできます。  
    ...
    - 2つのネットワークアダプターがある場合: 一方のネットワークアダプターがインターネットに接続されていて、もう一方のネットワークアダプターが内部ネットワークに接続されている場合、もう一方のネットワークアダプターが境界ネットワークに接続されていて、もう一方のネットワークアダプターが内部ネットワークに接続されている場合。  
