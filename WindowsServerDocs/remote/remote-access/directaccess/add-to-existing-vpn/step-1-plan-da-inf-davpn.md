...
1.  使用するネットワーク アダプターのトポロジを決定します。 リモート アクセスは次のいずれかを使ってセットアップできます。  
    ...
    -   2 つのネットワーク アダプターのファイアウォール、またはルーター デバイスに、1 つのネットワーク アダプターが境界ネットワークと他の内部に接続されているか、インターネットおよび内部ネットワーク、または NAT の内側に他に接続されている 1 つのネットワーク アダプターを使用したエッジで、ネットワーク。  
  
    -   1 つのネットワーク アダプターを使用した NAT デバイスの内側にリモート アクセス サーバーが NAT デバイスの内側にインストールされているし、1 つのネットワーク アダプターが内部ネットワークに接続されています。  
