...
## <a name="configure-cas-and-certificates"></a><a name="ConfigCAs"></a>Ca と証明書の構成  
...
### <a name="to-create-the-network-location-server-and-web-probe-dns-records"></a><a name="NLS_DNS"></a>ネットワークロケーションサーバーと web プローブ DNS レコードを作成するには  
...
## <a name="configure-the-network-location-server"></a><a name="ConfigNLS"></a>ネットワークロケーションサーバーを構成する  
