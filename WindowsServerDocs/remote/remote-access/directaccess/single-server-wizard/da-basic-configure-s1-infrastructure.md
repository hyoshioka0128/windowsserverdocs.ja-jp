...
![Windows PowerShell](../../../media/Step-1-Configure-the-DirectAccess-Infrastructure/PowerShellLogoSmall.gif)Windows PowerShell と同等のコマンド。  
...
-   [手順 2:基本的な DirectAccess サーバーを構成します。](da-basic-configure-s2-server.md)  
