...
|[高度な DirectAccess 展開を計画します。](Plan-an-Advanced-DirectAccess-Deployment.md)|DirectAccess クライアントを含むセキュリティ グループでリモート アクセス サーバーを構成します。|  
...
![インストールの進行状況の成功](../../../media/Step-2-Configuring-DirectAccess-Servers/PowerShellLogoSmall.gif)Windows PowerShell と同等のコマンド。  
...
-   [ステップ 1: 高度な DirectAccess インフラストラクチャを構成します。](da-adv-configure-s1-infrastructure.md)  
  
## <a name="next-step"></a>次の手順  
  
-   [手順 3:デプロイを検証します。](Step-3-Verify-the-Deployment.md)  
