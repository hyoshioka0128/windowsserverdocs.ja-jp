...
### <a name="enable-load-balancing"></a>負荷分散の有効化
...
9. **スタート**画面で、「**nlbmgr.exe**」と入力し、enter キーを押します。 [**ユーザー アカウント制御**] ダイアログ ボックスが表示されたら、表示された操作が正しいことを確認し、[**はい**] をクリックします。
