...
## <a name="31-plan-load-balancing"></a><a name="bkmk_2_1_Plan_LB"></a>3.1 負荷分散を計画します。
...
### <a name="311-external-load-balancer-configuration-example"></a><a name="ELBConfigEx"></a>3.1.1 外部ロード バランサーの構成例
...
## <a name="32-plan-ip-https"></a><a name="bkmk_2_2_NLB"></a>3.2、IP-HTTPS を計画します。
...
## <a name="33-plan-for-vpn-client-connections"></a><a name="BKMK_3.3"></a>3.3 が VPN クライアント接続を計画します。
...
## <a name="34-plan-the-network-location-server"></a><a name="BKMK_nls"></a>3.4 ネットワーク ロケーション サーバーを計画します。
