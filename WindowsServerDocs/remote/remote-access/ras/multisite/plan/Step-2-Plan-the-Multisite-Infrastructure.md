...
-   サーバー Gpo の場合は、特定のエントリポイントに関連付けられているドメインコントローラーを特定するために、PowerShell コマンドレットを実行し `Get-DAEntryPointDC -EntryPointName <name of entry point>` ます。
