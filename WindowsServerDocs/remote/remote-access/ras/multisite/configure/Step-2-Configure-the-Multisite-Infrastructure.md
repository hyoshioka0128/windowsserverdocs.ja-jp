...
## <a name="BKMK_ConfigAD"></a>2.1。 追加の Active Directory サイトを構成する  
...
## <a name="BKMK_AddDC"></a>2.2。 追加のドメインコントローラーを構成する  
...
2.  コンソールツリーで、新しいグループを追加するフォルダー (たとえば、corp.contoso.com/Users) を右クリックします。 をポイント **新規**, 、クリックして **グループ**します。  
...
### <a name="DCMaintandDowntime"></a>ドメインコントローラーの保守とダウンタイム  
...
#### <a name="ChangeDC"></a>サーバー Gpo を管理するドメインコントローラーを変更するには  
...
### <a name="ChangeTwoDCs"></a>サーバー Gpo を管理する2つ以上のドメインコントローラーを変更する  
...
### <a name="ConfigDistOptimization"></a>構成配布の最適化  
