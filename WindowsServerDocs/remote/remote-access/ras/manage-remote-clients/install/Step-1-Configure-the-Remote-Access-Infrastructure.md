...
![Windows PowerShell](../../../../media/Step-1-Configure-the-Remote-Access-Infrastructure/PowerShellLogoSmall.gif)Windows PowerShell と同等のコマンド。  
...
-   [手順 2:リモート アクセス サーバーを構成します。](Step-2-Configure-the-Remote-Access-Server.md)
