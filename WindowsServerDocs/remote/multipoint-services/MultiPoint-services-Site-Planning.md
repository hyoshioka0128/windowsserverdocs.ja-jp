...
**小規模ビジネスオフィス**このセットアップでは、MultiPoint Services を実行しているコンピューターを中央の場所に配置し、オフィス内のユーザーがローカルエリアネットワーク LAN を使用してそのコンピューターに接続し \( \) ます。
