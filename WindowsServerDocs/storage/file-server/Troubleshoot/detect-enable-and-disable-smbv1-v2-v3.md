...
#### <a name="windows-server-2012-r2-and-windows-server-2016-server-manager-method-for-disabling-smb"></a>Windows Server 2012 R2 および Windows Server 2016: サーバーマネージャー SMB を無効にする方法
