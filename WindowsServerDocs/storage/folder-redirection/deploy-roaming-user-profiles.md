...
3. **プロファイル**セクションで、**プロファイル パス:** チェック ボックスをオンし続けて、ユーザーのローミング ユーザー プロファイルを保存する場所をファイル共有にパスを入力`%username%`(自動的に置き換え、ユーザーがサインイン ユーザー名の最初の時間)。 例:
...
| 日付 | 説明 |Reason|
| --- | ---         | ---   |
| 2019 年 5 月 1 日、 | Windows Server 2019 のアップデートを追加 |
