...
8. ディスクを別の PC に接続します。
    ...
    ディスクが別の PC で機能しない場合は、お使いの PC ではなく、ディスクで何か問題が発生していることを示しています。 残念なことですが。 [Microsoft コミュニティ](https://answers.microsoft.com/)のサイトでヘルプを検索して質問するか、ディスクの製造元または [Microsoft サポート](https://support.microsoft.com/contactus/)に問い合わせてください。
