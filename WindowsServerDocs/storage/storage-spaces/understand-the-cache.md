...
ms.locfileid: "4678622"
---
# 記憶域スペース ダイレクトのキャッシュについて
...
複数の種類のドライブが展開に存在する場合、記憶域スペース ダイレクトは、自動的に "最速" の種類のドライブをキャッシュとして使用します。 残りのドライブは容量として使われます。
