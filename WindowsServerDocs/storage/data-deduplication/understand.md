...
|------------|-----------------|------------------|
| <a id="usage-type-default"></a>既定 | 汎用ファイル サーバー:<ul><li>チームの共有</li><li>作業フォルダー</li><li>フォルダー リダイレクト</li><li>ソフトウェア開発用の共有</li></ul> | <ul><li>バックグラウンドの最適化</li><li>既定の最適化ポリシー:<ul><li>ファイルの最小経過期間 = 3 日</li><li>使用中のファイルの最適化 = なし</li><li>部分的なファイルの最適化 = なし</li></ul></li></ul> |
