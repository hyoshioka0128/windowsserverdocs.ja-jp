...
6. すべての移行元サーバーと、windows Server 2012 R2 または Windows Server 2016 を実行しているすべての移行先サーバーで、Windows 管理センターで各サーバーに接続し、**サーバーマネージャー** (Windows 管理センター) に移動して >**ファイアウォール** > **受信規則** を選択し、次の規則が有効になっていることを確認します。
