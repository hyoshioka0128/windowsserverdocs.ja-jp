...
ms.locfileid: "9150872"
---
# Windows Server 2019 のライセンス認証

>適用対象: Windows Server 2019、Windows Server 2016

次の情報では、Windows Server 2019 に関連するキー管理サービス (KMS) ライセンス認証を計画する必要がある計画の最初の考慮事項について説明します。 ここに挙げられたものより古いオペレーティング システムが関係する KMS ライセンス認証については、「[手順 1: ライセンス認証方法の確認と選択](https://technet.microsoft.com/library/jj134256(WS.11).aspx)」をご覧ください。
...
>[!NOTE]
>- 更新プログラムは、これらの新しいクライアントのいずれかのライセンス認証をサポートするために KMS サーバー上に必要な可能性があります。 ライセンス認証のエラーが発生したときは、この表の下に示した適切な更新プログラムを適用してあるかどうかを確認してください。
>- 仮想マシンで作業している場合は、[仮想マシンの自動ライセンス認証](vm-activation-19.md)情報と AVMA キーをご覧ください。

|プロダクト キー グループ|KMS をホストすることができます。|この KMS ホストによってライセンス認証される Windows エディション|  
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|  
...
>- Windows 10 を実行しているクライアントのライセンス認証をサポートするには、Windows 7 および Windows Server 2008 R2 にインストールされている KMS を更新する必要があります。 詳細については、[Windows 7 および Windows Server 2008 R2 KMS ホストが Windows 10 をアクティブ化できるようにする更新プログラム](https://support.microsoft.com/help/3079821/update-that-enables-windows-7-and-windows-server-2008-r2-kms-hosts-to-activate-windows-10)を参照してください。  
>- KMS を Windows Server 2012 のインストールは、Windows 10 と Windows Server 2016 または Windows Server 2019 を実行しているクライアントまたはそれ以降のクライアントまたはサーバー オペレーティング システムのライセンス認証をサポートするために更新する必要があります。 詳細については、[更新プログラムのロールアップが Windows Server 2012 の 2016 の年 7 月](https://support.microsoft.com/help/3172615/july-2016-update-rollup-for-windows-server-2012)を参照してください。 
>- Windows 8.1 または Windows Server 2012 R2 で KMS のインストールは、Windows 10 と Windows Server 2016 または Windows Server 2019 を実行しているクライアントまたはそれ以降のクライアントまたはサーバー オペレーティング システムのライセンス認証をサポートするために更新する必要があります。 詳細については、[更新プログラムのロールアップ Windows 8.1 および Windows Server 2012 R2 の 2016 の年 7 月](https://support.microsoft.com/help/3172614/july-2016-update-rollup-for-windows-8.1-and-windows-server-2012-r2)を参照してください。  
>- Windows Server 2008 R2 は、Windows Server 2016、Windows Server 2019 では、またはそれ以降のオペレーティング システムを実行しているクライアントのライセンス認証をサポートするために更新ことはできません。 
...
Windows 10、Windows Server 2019、Windows Server 2016、Windows 8.1、Windows Server 2012 R2、Windows Server 2012、Windows 7、Windows Server 2008 R2 のボリューム ライセンス エディションを実行しているコンピューターは、既定では、KMS クライアントとその他の構成がないです。必要になります。

コンピューターを KMS ホスト、MAK、または製品版の KMS クライアントから変換する場合は、該当する KMS クライアント セットアップ キーをインストールしてください。 詳細については、[KMS クライアント セットアップ キー](../get-started/KMSclientkeys.md)を参照してください。 
