...
| **ネットワーク名** |  **・**  | **隠す** | **トラックの VLAN ID** | **活用**  |                                                           **予約 (例)**                                                           |
|------------------|--------------|----------|----------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
|    パブリック VIP    |  41.40.40.0  |    27    |          該当なし          |  41.40.40.1  |                                    41.40.40.1 – router 41.40.40.2-SLB/MUX VIP 41.40.40.3-IPSec S2S VPN VIP                                    |
|   プライベート VIP    |  20.20.20.0  |    27    |          該当なし          |  20.20.20.1  |                                                        20.20.20.1-既定の GW (ルーター)                                                         |
|     GRE VIP      |  31.30.30.0  |    24    |          該当なし          |  31.30.30.1  |                                                             31.30.30.1-既定の GW                                                             |
...
VIP サブネットの次ホップ\) などのルーティング情報 \(、内部 BGP ピアリングを使用して、SLB/MUX および RAS ゲートウェイによって物理ネットワークにアドバタイズされます。 VIP 論理ネットワークには VLAN が割り当てられておらず、レイヤー2スイッチで事前構成されていません (例: ラック間のスイッチ)。  
