...
Windows Server 2016 Hyper-v ネットワーク仮想化は、企業が専用 IaaS クラウドを拡張するときの管理オーバーヘッドを削減するポリシーベースでソフトウェア制御のネットワーク仮想化を提供し、より高いリソース使用率を実現するための柔軟性とスケーラビリティの向上をクラウドホストに提供します。
...
|       コンテンツ タイプ       |                                                                                                                                参考資料                                                                                                                                |
|--------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **コミュニティ リソース**  |     -   [プライベートクラウドアーキテクチャのブログ](/archive/blogs/privatecloud/cloud-datacenter-network-architecture-in-the-windows-server-8-era)<br />-質問:[cloudnetfb@microsoft.com](mailto:%20cloudnetfb@microsoft.com)     |
