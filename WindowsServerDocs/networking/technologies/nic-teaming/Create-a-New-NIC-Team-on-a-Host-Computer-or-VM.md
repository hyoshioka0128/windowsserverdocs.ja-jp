...
14. [**ハードウェアの追加**] で、[**ネットワークアダプター**] をクリックし、[**追加**] をクリックします。
   ...
   ![ネットワーク アダプターを追加する](../../media/Create-a-New-NIC-Team-in-a-VM/nict_hvs_06.jpg)
