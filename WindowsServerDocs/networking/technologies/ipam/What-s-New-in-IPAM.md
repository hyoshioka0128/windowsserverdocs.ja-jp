...
## <a name="BKMK_IPAM2012R2"></a>IPAM サーバーの更新プログラム  
...
### <a name="EDNS"></a>強化された DNS サービス管理  
...
### <a name="DDI"></a>統合 DNS、DHCP、IP アドレス (DDI) 管理  
...
### <a name="bkmk_ps"></a>Windows PowerShell によるロールベースの Access Control のサポート  
