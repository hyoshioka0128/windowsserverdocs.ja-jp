...
- [スクリプト Test-Rdma のダウンロード](https://github.com/Microsoft/SDN/blob/master/Diagnostics/Test-Rdma.ps1)
...
次の Windows PowerShell コマンドを使用して、リモートノードの IP アドレスが RDMA\-に対応していることを確認できます。
