...
-   ターゲット コンピューターのプレインストールされたイメージでエンド ユーザーのエクスペリエンスをテストする場合、初期構成セクションを使用して有人モードまたは無人モードでインストールをウォークスルーします。 その方法については、「 [Create the Initial Configuration section](Create-the-Cfg.ini-File.md#BKMK_CreateInit2)」をご覧ください。  
...
2.  InitialConfiguration セクションを作成するには、次のテキストを追加します。  
    ...
    |*国*|(省略可能) 目的の国/地域を表す文字列。 以下に例を示します。米国の場合、US です。|  
    |*ServerName*|サーバー名は、ネットワーク上のサーバーを一意に識別します。 サーバー名は、次の条件を満たしている必要があります。<br /><br /> -最大 15 文字にことができます。<br /><br /> -文字、数字、およびハイフン (-) を含めることができます。<br /><br /> -ハイフンで開始しない必要があります。<br /><br /> -スペースを含めることができません必要があります。<br /><br /> で数値だけは使用できません。<br /><br /> 以下に例を示します。ContosoServer。|  
    ...
    |*NetbiosName*|NetBIOS 名は、サーバー上で実行されているリソースを識別するために使用されます。 15 文字まで使用できます。 以下に例を示します。Contoso。|  
    ...
    |*[キーボード]*|キーボードには次の 2 つの形式を使用できます。<br /><br /> - **入力言語: キーボード レイアウトです。** たとえば、0409:00000409 の場合、**:** の前の 0409 は入力言語で、**00000409** はキーボード レイアウトです。 キーボード レイアウトの一覧は、レジストリ キー **HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control\Keyboard Layouts**の下で確認できます。<br /><br /> - **入力言語: IME 識別子。** 以下に IME 識別子の完全な一覧を示します。<br /><br /> -{E429B25A-E5D3-4D1F-9BE3-0C608477E3A1}{8F96574E-C86C-4bd6-9666-3F7327D4CBE8} アムハラ語入力方式<br /><br /> -{81d4e9c9-1d3b-41bc-9e6c-4b40bf79e35e} {fa550b04-5ad7-411f-a5ac-ca038ec515d7} Microsoft Pinyin - Simple Fast (簡体字中国語)<br /><br /> -{531FDEBF-9B4C-4A43-A2AA-960E8FCDC732}{B2F9C502-1742-11D4-9790-0080C882687E} 繁体字) - 新しい音声<br /><br /> -{531FDEBF-9B4C-4A43-A2AA-960E8FCDC732}{4BDF9F03-C7D3-11D4-B2AB-0080C882687E} 中国語 (繁体字 - ChangJie<br /><br /> -{531FDEBF-9B4C-4A43-A2AA-960E8FCDC732}{6024B45F-5C54-11D4-B921-0080C882687E} 中国語 (繁体字 - 簡易<br /><br /> -{E429B25A-E5D3-4D1F-9BE3-0C608477E3A1}{D38EFF65-AA46-4FD5-91A7-67845FB02F5B} 体字中国語繁配列<br /><br /> -{E429B25A-E5D3-4D1F-9BE3-0C608477E3A1}{037B2C25-480C-4D7F-B027-D6CA6B69788A} 体字中国語繁 DaYi<br /><br /> -{03B5835F-F03C-411B-9CE2-AA23E1171E36}{A76C93D9-5523-4E90-AAFA-4DB112F9AC76} Microsoft IME (日本語)<br /><br /> -{A028AE76-01B1-46C2-99C4-ACD9858AE02F}{B5FE1F02-D5F2-4445-9C03-C568F23C99A1} Microsoft IME (韓国語)<br /><br /> -{A1E2B86B-924A-4D43-80F6-8A820DF7190F}{B60AF051-257A-46BC-B9D3-84DAD819BAFB} の古いハングル IME (韓国語)<br /><br /> -{E429B25A-E5D3-4D1F-9BE3-0C608477E3A1}{409C8376-007B-4357-AE8E-26316EE3FB0D} イ語の入力メソッド<br /><br /> -{E429B25A-E5D3-4D1F-9BE3-0C608477E3A1}{3CAB88B7-CC3E-46A6-9765-B772AD7761FF} ティグリニア語入力方式|  
    |*設定*|更新に関するユーザーの選択を設定します。 次のいずれかの値を使用します。<br /><br /> **-All**が推奨設定を使用します。<br /><br /> **-更新**equals は、重要な更新プログラムをインストールします。 のみ<br /><br /> **-None** equals は、更新プログラムを確認しません。|  
    |*UserName*|セットアップ中に作成された新しい管理者アカウントの名前。 管理者アカウント名と標準のユーザー アカウント名は、次の条件を満たしている必要があります。<br /><br /> -最大 19 文字にすることができます。<br /><br /> - Cannot contain / \  [ ] &#124; < > + = ; , ? *<br /><br /> の起動したり、末尾がピリオドで必要があります。<br /><br /> -2 つの連続するピリオドを含めることができません必要があります。<br /><br /> でサーバー名または内部ドメイン名と同じはできません。<br /><br /> で管理者や Guest などの定義済みのユーザー名と同じはできません。|  
    |*PlainTextPassword*|これは、セットアップ中に作成された新しい管理者アカウントのパスワードです。<br /><br /> -少なくとも 8 文字にする必要があります。<br /><br /> -次の 4 つのカテゴリのうち、少なくとも 3 つを含める必要があります。<br /><br /> の大文字文字。<br /><br /> の小文字文字。<br /><br /> 数値。<br /><br /> -記号。|  
    ...
    |LaunchPadHiddenTasks|バックアップ エントリを非表示にすることができます (オプション) または/スタート パッドに管理ダッシュ ボード エントリ。<br /><br /> -をダッシュ ボードを無効にします。LaunchPadHiddenTasks=Microsoft.LaunchPad.AdminDashboard<br /><br /> -にバックアップを無効にします。LaunchPadHiddenTasks=Microsoft.LaunchPad.Backup<br /><br /> -にバックアップとダッシュ ボードの両方を無効にします。LaunchPadHiddenTasks=Microsoft.LaunchPad.Backup,Microsoft.LaunchPad.AdminDashboard|  
