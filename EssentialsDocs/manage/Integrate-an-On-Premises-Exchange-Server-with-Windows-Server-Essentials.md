...
|          MX          | メール エクスチェンジャー (MX) |                                            ホスト名=@<br /><br /> アドレス=mail.contoso.com<br /><br /> 優先順位=0                                             |                                                                                                                                                                                                      Exchange Server を実行しているオンプレミスサーバーに到着する email@contoso.com の電子メールメッセージのルーティングを提供します。                                                                                                                                                                                                       |
