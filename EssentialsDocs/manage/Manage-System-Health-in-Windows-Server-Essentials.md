...
##  <a name="BKMK_AddIn"></a>状態レポートアドインについて  
...
###  <a name="BKMK_Generate"></a>必要に応じて、またはスケジュールに基づいてレポートを生成する  
...
###  <a name="BKMK_Customize"></a>レポートの内容をカスタマイズする  
 状態レポートには次が含まれます。  
...
###  <a name="BKMK_emailreport"></a>レポートを電子メールで送信する  
...
##  <a name="BKMK_View"></a>アラートビューアーを使用してアラートを表示する  
...
##  <a name="BKMK_Organize"></a>アラートビューアーでのアラートの整理  
...
##  <a name="BKMK_Respond"></a>アラートに応答する  
...
##  <a name="BKMK_Email"></a>アラートの電子メール通知を設定する  
...
###  <a name="BKMK_list"></a>電子メール通知が生成されるアラート  
...
###  <a name="BKMK_SMTP"></a>Windows Server Essentials で電子メールでアラート通知を送信するようにサーバーの SMTP を構成する  
...
##  <a name="BKMK_Potential"></a>潜在的なコンピューターアラート  
