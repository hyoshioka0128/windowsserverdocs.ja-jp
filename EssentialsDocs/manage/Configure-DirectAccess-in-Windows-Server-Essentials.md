...
-   [手順 3: ネットワークロケーションサーバーの証明書と DNS レコードを準備する](Configure-DirectAccess-in-Windows-Server-Essentials.md#BKMK_DNS)  
...
#### <a name="to-add-remote-accregss-management-tools--reg"></a>リモートの Acc&reg;ss 管理ツールを追加するには &reg;
