...
###  <a name="BKMK_DeleteSvcAcctSetting"></a>[サービスとしてログオン] アカウント設定を削除します。  
...
###  <a name="BKMK_EvaluateHealth"></a>移行元サーバーの正常性を評価する  
...
###  <a name="BKMK_MigrateLOB"></a>基幹業務アプリケーションを移行するための計画を作成する  
